...
/* This is Ecf.h, the public header file for the  ECF library. */
...
//	       NOISE_POISSON_FIT, NOISE_GAUSSIAN_FIT, NOISE_MLE } noise_type; //TODO ARG these two enums are now defined in "ecfpublic.h"
...
int GCI_SPA_1D_marquardt_global_exps_instr(
					...
					noise_type noise, float sig[], int ftype,
					float **param, int paramfree[], int nparam,
					restrain_type restrain, int drop_bad_transients,
					int spa_param, int spa_nvalues,
					float spa_low, float spa_high,
