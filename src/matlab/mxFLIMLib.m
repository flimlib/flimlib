%MXFLIMLIB Perform lifetime fit on TCSPC data
%   LMA_PARAM = MXFLIMLIB(TRANSIENT, PROMPT, X_INC, FIT_START) Fits a
...
%   
%   LMA_PARAM = MXFLIMLIB(TRANSIENT, PROMPT, X_INC, FIT_START, FIT_TYPE)
...
%           4           [Z; A; tau; H; chi_sq]
%
%   LMA_PARAM = MXFLIMLIB(TRANSIENT, PROMPT, X_INC, FIT_START, ...
...
%       MXFLIMLIB(TRANSIENT, PROMPT, X_INC, FIT_START) RLD_param provides
...
%
%   % *** Perform the fit ***
%   paramsLMA = mxFLIMLib(transient, prompt, xincr, fit_start);
%   
%   fprintf('A:\t%g\ntau:\t%g\nZ:\t%g\nchi2:\t%g\n', paramsLMA([2 3 1 4]));
%
% GNU GPL license 3.0
