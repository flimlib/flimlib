  ...
  RLD return_value 2
  RLD estimate A 11515.* T 2.392674 Z 208.731* X2 8.9979* (glob)
  ...
  TRI2 TR Settings File
  RLD return_value 2
  RLD estimate A 11515.* T 2.392674 Z 208.7319* X2 8.99793* (glob)
  LMA return value [12][0-9] (re)
  LMA fitted A1 8786.6* T1 2.84177* A2 5456.7* T2 0.77975* Z 100.473* X2 1.210* (glob)
